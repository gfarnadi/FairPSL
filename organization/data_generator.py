...
def generate_submission(user_file, manager_file, quality_file, feedback_file, submit_file, submission_rate_f, submission_rate_m, feedback_equal_p, feedback_equal_mn, feedback_notequal_mp, feedback_notequal_mn, quality_rate):
